...
function usePortfolioDashboard() {
  ...
  function openAllocationsScreen() {
    setActiveScreen(SCREENS.ALLOCATIONS)
  }
  ...
  return {
    ...
    formatTradeTimestamp,
    handleAddTrade,
    isAllocationsScreen: activeScreen === SCREENS.ALLOCATIONS,
    isDashboardScreen: activeScreen === SCREENS.DASHBOARD,
    isTradesScreen: activeScreen === SCREENS.TRADES,
    isEditMode: Boolean(editingTradeId),
    isModalOpen,
    money: moneyFormatter,
    onInputChange,
    openDashboardScreen,
    openAllocationsScreen,
    openTradeModal,
    openTradesScreen,
    portfolioStats,
    renderTradeLine,
